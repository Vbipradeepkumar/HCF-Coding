...
$values=array();
$handle = @fopen("/home/sseit/Desktop/txt/hcgraphresult.txt", "r"); // Open file form read.
//$handle1 = @fopen("/home/sseit/Desktop/txt/randresult.txt", "r");
//$handle = @fopen("/home/sseit/Desktop/txt/randresult.txt", "r"); // Open file form read.
...
$graphTitle = "Comparative Graph";
$xLabel 	= "Status";
$yLabel 	= "No. of Entries"; 
 
$data['Without IP Aggregation'] = $src;
$data['With IP Aggregation'] = $hc;
