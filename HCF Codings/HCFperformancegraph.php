...
$line2=0;
$values=array();
$handle = @fopen("txt/hcfoutput.txt", "r"); // Open file form read.
$handle1 = @fopen("txt/bwlimitinginput1.txt", "r");
$handle2 = @fopen("txt/spoofed.txt", "r");
...
$data['Total No. of Packets - 184'] = $line1;
$data['Packets Accepted - 120'] = $line2;
$data['Packets Spoofed- 64'] = $line3;
